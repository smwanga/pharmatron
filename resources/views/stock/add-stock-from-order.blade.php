                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 {{error('pack_size')}}">
                                                        ...
                                                        <input value="{{old('pack_size', $item->pack_size)}}" type="number" class="form-control" name="pack_size" id="pack-size" placeholder="Pack Size">
                                                        {!! error_msg('pack_size') !!}
                                                    </div>
                                                    <div class="form-group col-md-4 {{error('total_stock')}}">
                                                        <strong for="total-stock">@lang('main.total_stock')</strong>
