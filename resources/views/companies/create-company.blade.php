                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="row">
                                        <div class="form-group col-md-6 {{error('company_name')}}">
                                            ...
                                            <input value="{{old('company_name')}}" type="text" class="form-control" name="company_name" id="name" placeholder="@lang('main.company_name')">
                                            {!! error_msg('company_name') !!}
                                        </div>
                                        <div class="form-group  col-md-6 {{error('email')}}">
                                            <label for="stockCode">@lang('main.email')</label>
                                            <input type="email" value="{{old('email')}}" class="form-control col-md-6" name="email" id="email" placeholder="@lang('main.example_email')">
                                             {!! error_msg('email') !!}
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 {{error('website')}}">
                                            ...
                                            <input value="{{old('website')}}" type="text" class="form-control" name="website" id="website" placeholder="@lang('main.example_site')">
                                             {!! error_msg('website') !!}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 {{error('address')}}">
                                            ...
                                            <input type="text" value="{{old('address')}}" class="form-control" name="address" id="address" placeholder="Full Address or Postal Address">
                                             {!! error_msg('address') !!}
                                        </div>
                                        <div class="form-group col-md-6 {{error('city')}}">
                                            <label for="city">@lang('main.city')</label>
                                            <input value="{{old('website')}}" type="text" class="form-control" name="city" id="city" placeholder="@lang('main.city')">
                                             {!! error_msg('city') !!}
                                        </div>
                                    </div>
                                    <div class="row">
