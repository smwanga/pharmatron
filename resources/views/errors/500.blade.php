...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>500 Internal Server Error || {{app_config('site_name')}}</title>
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-offset-1 col-xs-10">
          <div class="error-container">
            <div class="error-main">
              ...
              <div class="error-description-mini"> The server has encountred an error, Report this issue if it persists </div>
              <br>
              <br>
